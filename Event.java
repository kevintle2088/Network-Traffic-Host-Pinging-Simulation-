 ...
 * Manages event IDs, assigning a unique event ID per new event created.  Provi * Manages event IDs, assigning a unique event ID per new event created.  Provides getters for event ID, insertion time,des getters for event ID, insertion time,
 * and arrival time.
 */
